...
$(document).ready(function(){
    consultarColaboracion(); //id carpeta Mis proyectos
  })
  
  
  
  function consultarColaboracion(){
      //consultar favoritos
      var carpetas = ""
      $.ajax({
          url:`carpetas/carpetas-compartidos`,
          method: "GET",
          dataType: 'json',
  ...
  function cargarArchivos(){
    $.ajax({
      url:`archivos/archivos-compartidos`,
      method: "GET",
      dataType: 'json',
      success: function(res){       
          console.log(res);
